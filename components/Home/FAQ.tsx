...
export default function FAQ({ faq: faqRaw } : { faq: any }) {
    ...
    return (
        <section className="flex flex-col p-10 items-center md:p-20 md:py-16 lg:px-32 lg:py-24 xl:px-40 items-left bg-orange-300 z-10 relative svg-background" id="FAQ">
