...
export default function FAQ({ faq: faqRaw } : { faq: any }) {
    ...
    return (
        <section className="flex flex-col p-10 items-center md:p-20 md:py-16 lg:px-32 lg:py-24 xl:px-40 items-left bg-orange-300 z-10 relative wiggles-background" id="FAQ">
            <div className="flex flex-col text-center mb-8">
                <h1 className="text-5xl text-gray-700 font-bold underline">frequently asked questions</h1>
            </div>

            <div className='flex flex-col lg:flex-row lg:gap-x-4 bg-[#CF985F] p-6 lg:px-8 w-full'>
